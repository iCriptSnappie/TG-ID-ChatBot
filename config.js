// ---------------------------- VARIABLES ---------------------------- //
const API_ID = parseInt(process.env.API_ID || "7599658");
const API_HASH = process.env.API_HASH || "4ef7f662cfc91d9920a2d7349fd5d3db";
const STRING_SESSION = process.env.STRING_SESSION || null;
const OWNER_ID = parseInt(process.env.OWNER_ID || "6736620260");
const MONGO_URL = process.env.MONGO_URL || null;
const SUPPORT_GRP = process.env.SUPPORT_GRP || "BESTIESZONE2";
const UPDATE_CHNL = process.env.UPDATE_CHNL || "ll_Feelings_ll";
const OWNER_USERNAME = process.env.OWNER_USERNAME || "iCriptSnappie";
// ---------------------------- VARIABLES ---------------------------- //
...
console.log(`SUPPORT_GRP: ${SUPPORT_GRP}`);
console.log(`UPDATE_CHNL: ${UPDATE_CHNL}`);
console.log(`OWNER_USERNAME: ${OWNER_USERNAME}`);
// ---------------------------- PRINT IN CONSOLE ---------------------------- //

// Example of using arrays
// console.log("Random Start Images:");
// IMG.forEach(img => console.log(img));

// console.log("Random Stickers:");
// STICKER.forEach(sticker => console.log(sticker));

// console.log("Emojis:");
// EMOJIOS.forEach(emoji => console.log(emoji));
